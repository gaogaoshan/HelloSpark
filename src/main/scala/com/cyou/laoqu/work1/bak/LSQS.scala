package com.cyou.laoqu.work1.bak

import com.cyou.laoqu.utils.{ArrUtil, DBUtil}
...
//    val bbb = selectDf.filter(selectDf("ref_url").contains("yeyou.com"))
    ...
    mapRusult.saveAsTextFile("hdfs:/tmp/hugsh/laoqu/113Result")//  /hdfs/tmp/hugsh/laoqu
